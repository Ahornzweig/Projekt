...
lib.ssMetadata = [
		{name:"070102_atlas_", frames: [[0,802,314,246],[316,802,308,244],[544,1319,322,10],[316,1048,308,244],[834,259,166,257],[544,1343,280,10],[626,802,308,244],[834,0,166,257],[272,1294,270,269],[626,1048,270,269],[544,1331,280,10],[0,1050,270,269],[0,0,832,800],[834,518,10,279],[0,1321,270,269],[846,518,10,279]]}
];
...
(lib.CachedTexturedBitmap_1 = function() {
	this.initialize(ss["070102_atlas_"]);
	this.gotoAndStop(0);
...
(lib.tRight = function(mode,startPosition,loop) {
...
(lib.tLeft = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.tBottom = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.SquareNew = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// stage content:
(lib._070102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.tBlue).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.tRed).wait(1));
...
// library properties:
lib.properties = {
	id: 'A93B6E2603EC154AAC2B97628C9D132C',
	width: 700,
	height: 500,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/070102_atlas_.png?1575722433841", id:"070102_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1575722433884", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1575722433884", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1575722433884", id:"an.CSS"}
	],
	preloads: []
};
